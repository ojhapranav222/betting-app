    ...
    <div className="w-full bg-opacity-10 bg-black rounded-lg backdrop-blur-md h-[80px] flex sm:justify-between justify-around items-center sm:px-10 fixed top-0 z-[99]">
      ...
      {isLoggedIn ? (
        <div className='flex gap-12 items-center'>
          ...
          {dropWallet && ( 
            <ul className='bg-white absolute top-20 rounded-xl right-24 border-2 border-black'>
          ...
          {dropVisible && ( 
            <ul className='bg-white border-2 border-black absolute top-20 rounded-xl right-6'>
        ...
        <div className='text-black flex justify-between w-[20%]'>
